...
$(document).ready(function(){
  ...
  function setDates(dateObj, hijriData){
    ...
    $(".hijri-date").text(hijriData.iDate() + " " + browser.i18n.getMessage(hijriMonths[hijriData.iMonth()]) + " " + hijriData.iYear());
  }
  ...
  function getNewCalendar () {
    ...
    browser.storage.local.set({calendar: {date: currentDate.toString(), data: calendarData, 
